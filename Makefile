...
#---------------------------------------------------------------------------------
LIBS	:=	-lgrrlib -lfreetype -lpng -lz -lbz2 -lbrotlidec -lbrotlicommon -lfat -lwiiuse -lbte -logc -lm
...
#---------------------------------------------------------------------------------
# Convert PNG to TPL, then compile TPL into an object file and header
#---------------------------------------------------------------------------------
%.tpl.o %_tpl.h: %.png
	@echo Converting $(notdir $<) to TPL...
	@gxtexconv -i $< -o $(*).tpl
	@echo Embedding $(*).tpl...
	@$(bin2o)
